...
function update_user() {
	...
	var postdata = 'bankno='+bankno+"&provinceid="+province+"&cityno="+city+"&address="+address+"&accntnm="+accntnm+"&accntno="+accntno+"&scard="+scard+"&phone="+phone+'&status=1';
	if(id){
		postdata += "&id="+id
	}
...
function submit_deposit() {
	...
	if(pay_type == ''){
		...
		can_balance(1)
		return false;
	}else if(pay_type=='qb_wxpay'){
		typ="5";
	}else if(pay_type=='qb_wxpay2'){
		typ="5";
	}else if(pay_type=='qb_alipay2'){
		typ="2";
	}else if(pay_type=='qb_qqpay2'){
		typ="4";
	}
