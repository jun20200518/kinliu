...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="row">
                <div class="col-12">
                    <button type="button" class="btn btn-primary">所有用户</button>
                    <button type="button" class="btn btn-info">所有客户</button>
                    <button type="button" class="btn btn-info">所有代理商</button>
                    <button type="button" class="btn btn-info">今日客户</button>
                    <button type="button" class="btn btn-info">今日代理商</button>
                                                  ...
                                                  <?php
                                                    ...
                                                    for($i=0;$i<count($data);$i++)
                                                    {
                                                      echo "<tr role=\"row\" class=\"odd\">";
                                                        ...
                                                        echo "<a href=". yii\helpers\Url::to(['agentmanagement/disable'])."&id=".$data[$i]->ustatus.">
                                                        <button type=\"button\"
                                                           class=\"fz8 btn btn-danger btn-sm\">禁用</button></a>";
