                ...
                <div class="login-form">
                    ...
                    <?php $form = ActiveForm::begin(['options' => ['id' => 'login', 'method' => 'POST', 'enctype' => 'multipart/form-data']]) ?>
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>密码</label>
                                <?php $form->field($model,'password'->input('password',['class'=>'form-control','placeholder="請輸入密碼"'])->label(false)) ?>
                                ...
                                <?php Html::submitbutton('登入',['class'=>'btn btn-success btn-flat m-b-30 m-t-30');?>
