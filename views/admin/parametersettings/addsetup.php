                ...
                <div class="row">
                    <div class="col-md-12 table_scroll_bar">
                        <div class="card">
                            ...
                            <?php $form = ActiveForm::begin(['options' => ['id' => 'addsetup', 'method' => 'POST', 'enctype' => 'multipart/form-data']]) ?>
                            <div class="card-body">
                                          ...
                                          <div class="row form-group">
                                              <div class="col col-md-2">
                                                <?php
                                                  if($data->)
                                                ?>
                                                <label for="text-input" class=" form-control-label">网站名称：</label></div>
                                              <div class="col-12 col-md-10">

                                                <?= $form->field($model,'web_name')->input('text',['class'=>'form-control','value' => $data->value])->label(false) ?>
                                                <!-- <input type="text" id="text-input"
                                                      name="text-input" placeholder="澳汇金融" class="form-control"> -->
                                              </div>
                                          </div>
                                      </div>
