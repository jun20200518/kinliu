                ...
                <div class="col-md-12 table_scroll_bar">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">交易流水</strong>
                        </div>
<!--                        <div class="content mt-3">-->
...
if($db_order[$i]->is_win == "" ){
    echo "<td data-th=\"实际盈亏\"> </td>";
}else{
    if($db_order[$i]->is_win == 1 ){
        echo "<td data-th=\"实际盈亏\" class=\"text-danger\">".$db_order[$i]->ploss."</td>";
    }elseif($db_order[$i]->is_win==2){
        echo "<td data-th=\"实际盈亏\" class=\"text-success\">".$db_order[$i]->ploss."</td>";
    }
}
                                                if($db_order[$i]->is_win == "1" ){
