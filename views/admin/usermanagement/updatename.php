                ...
                <div class="col-md-12 table_scroll_bar">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">修改用户名</strong>
                        </div>
                        <div class="card-body">
                            <div id="bootstrap-data-table-export_wrapper"
                                 class="dataTables_wrapper dt-bootstrap4 no-footer">
                                <div class="row">
                                    <?php $form = ActiveForm::begin(['options' => ['id' => 'updatename', 'method' => 'POST', 'enctype' => 'multipart/form-data']]) ?>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-8">
                                                <?= $form->field($model,'username')->input('text',['class'=>'form-control','value'=>$userinfo->username] )->label(false) ?>
