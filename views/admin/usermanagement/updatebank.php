...
<!--                                                        </th>-->
                                                ...
                                                <?php
                                                for($i=0;$i<count($db_bankcard);$i++){
                                                    echo "<tr role=\"row\" class=\"odd\">";
                                                    echo "<td data-th=\"序号\">".$db_bankcard[$i]->id."</td>";
                                                    echo "<td data-th=\"银行名称\">".$db_bankcard[$i]->bankno."</td>";
//                                                    echo "<td data-th=\"开户支行\">长江支行</td>";
                                                    echo "<td data-th=\"开户名\">".$db_bankcard[$i]->accntnm."</td>";
                                                    echo "<td data-th=\"卡号\">".$db_bankcard[$i]->accntno."</td>";
                                                    echo "<td data-th=\"微信帐号\">".$db_bankcard[$i]->phone."</td>";
//                                                    echo "<td data-th=\"身份证号\">1314520</td>";
                                                    echo "<td data-th=\"处理\">";
                                                    if($db_bankcard[$i]->isdelete == 0){
                                                        echo "<a href=". yii\helpers\Url::to(['admin/usermanagement/updatebankmodify'])."&id=".$db_bankcard[$i]->id.">
                                                           <button type=\"button\" class=\"btn btn-primary btn-sm\">修改</button>";
                                                        echo " ";
                                                        echo "<a href=". yii\helpers\Url::to(['admin/usermanagement/updatebankignore'])."&id=".$db_bankcard[$i]->id.">
                                                            <button type=\"button\" class=\"btn btn-primary btn-sm\">忽略</button>";
                                                    }elseif($db_bankcard[$i]->isdelete == 1){
                                                        echo "已修改";
                                                    }elseif($db_bankcard[$i]->isdelete == 2){
                                                        echo "已忽略";
                                                    }
