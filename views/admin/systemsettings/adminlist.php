    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-12 table_scroll_bar">
                        <div class="card">
                                                ...
                                                <tbody>
                                                  ...
                                                  <?php
                                                    ...
                                                    for($i=0;$i<count($data);$i++){
                                                      ...
                                                      echo "<td data-th=\"编号\">".$data[$i]->uid."</td>";
                                                      echo "<td data-th=\"用户名\">".$data[$i]->username."</td>";
                                                      echo "<td data-th=\"身份\">管理員</td>";
                                                      echo "<td data-th=\"操作\">";
                                                      echo "<button type=\"button\" class=\"btn btn-primary btn-sm\"><i class=\"fa fa-pencil\"></i></button>";
                                                      echo "<a href=". yii\helpers\Url::to(['admin/systemsettings/adminlistdelete'])."&uid=".$data[$i]->uid.">
                                    ...
                                    <!-- <div class="row mt-3">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="bootstrap-data-table-export_info" role="status"
                                                aria-live="polite">显示页面 1 到 5 总共 57 页s</div>
                                        </div>
