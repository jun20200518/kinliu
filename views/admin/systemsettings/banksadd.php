...
<div id="right-panel" class="right-panel">
    ...
    <?php $form = ActiveForm::begin(['options' => ['id' => 'banksaddform', 'method' => 'POST', 'enctype' => 'multipart/form-data']]) ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-10">
                                            <?= $form->field($model,'banks_add')->input('text',['class'=>'form-control'])->label(false) ?>
