<?php
    ...
    $s = substr($db_bankcard->accntno,0, 4);
    $s1 = substr($db_bankcard->accntno, -3);
    $db_bankcard->accntno = $s."********".$s1;
?>
<!DOCTYPE html>
<html lang="en">
<?php
...
//              }
            ...
            <a href="<?php  echo yii\helpers\Url::to(['web/member/drawmoneyinfo2']) ?>" class="btn">修改帐户</a>
          </div>
