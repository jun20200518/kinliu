...
<head>
    ...
    <link href="/css/member_rule.css" rel="stylesheet">
...
<header class="mainheader">
            ...
            <div
                ...
                <div class="member__main__wrap member__main__wrap--with__sidemenu pt-3 pt-lg-0">
                    <div class="member__page__title d-none d-lg-flex align-items-center">
                        <div class="text">交易规则</div><span class="title__line"></span>
                    </div>
                    <div class="rule__content">
                        <div class="editor__wrap">
                            <div class="pic"><img src="/upload_files/member/pic-rules.jpg" alt=""></div>
                        </div>
                    </div>
                </div>
  ...
  <?php include("sidebar.php"); ?>
    ...
    <script type="text/javascript" src="/js/member_rule.js"></script>
</body>
