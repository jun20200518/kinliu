...
<head>
    ...
    <link href="/css/member_workflow.css" rel="stylesheet">
...
<?php include("menu.php"); ?>
            ...
            <div
                ...
                <div class="member__main__wrap member__main__wrap--with__sidemenu pt-3 pt-lg-0">
                    <div class="member__page__title d-none d-lg-flex align-items-center">
                        <div class="text">储值流程教学</div><span class="title__line"></span>
                    </div>
    ...
    <script type="text/javascript" src="/js/member_workflow.js"></script>
</body>
