...
<head>
    ...
    <link href="/css/member_fund.css" rel="stylesheet">
...
<header class="mainheader">
            ...
            <div
                ...
                <div class="member__main__wrap member__main__wrap--with__sidemenu pt-3 pt-lg-0">
                    <div class="member__page__title d-none d-lg-flex align-items-center">
                        <div class="text">资金流水</div><span class="title__line"></span>
                    </div>
  ...
  <?php include("sidebar.php"); ?>
    ...
    <script type="text/javascript" src="/js/member_fund.js"></script>
</body>
