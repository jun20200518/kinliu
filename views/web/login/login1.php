    ...
    <div id="tab1">
      ...
      <div id="contents">
        <section id="login" class="content">
            <?php $form = ActiveForm::begin(['options' => ['id' => 'login1', 'method' => 'POST', 'enctype' => 'multipart/form-data','style'=>'margin-top:60px']]) ?>
              <div class="frame">
                  <img src="img/phone.svg" />
                               <!-- <input class="enter" type="text" placeholder="请输入电话号码" /> -->
                   <?= $form->field($model,'account')
                      ->input('text',['class' => 'enter','placeholder' => '请输入电话号码'])
                      ->label(false) ?>
              </div>
              ...
              <div class="frame">
                  ...
                  <?= $form->field($model,'password')
                      ->input('password',['class' => 'enter','placeholder' => '请输入密码'])
                      ->label(false) ?>
              </div>
              <!--          </form>-->
            ...
            <?= Html::submitButton(' 送出',['class' => 'btn']);?>
            <?php ActiveForm::end(); ?>
          </section>

        <section id="registered" class="content">
          <form>
            <div class="frame">
        ...
        <section id="forgetpw" class="content">
