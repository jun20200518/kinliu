    ...
    <div class="page-wrap d-flex">
        ...
        <main class="main pagemain">
            <div class="container clearfix pt-5">
                <nav class="navigate d-flex flex-wrap"><span class="btn-back pointer">＜</span>
                    <div class="item__name">比特幣</div>
                </nav>
                <div class="d-flex flex-wrap" id="updateItem-wrap">
                    <div class="current__price">
                        <div class="title">現價</div>
                        <div class="value">81.13</div>
                    </div>
                    <div class="kaipan__price">
                        <div class="title">開盤</div>
                        <div class="value">80.43</div>
                    </div>
                    <div class="highest__price">
                        <div class="title">最高</div>
                        <div class="value">85.43</div>
                    </div>
                    <div class="lowest__price">
                        <div class="title">最低</div>
                        <div class="value">81.43</div>
                    </div>
                </div>
                <div class="d-flex align-items-center" id="chart-control-wrap">
                    <div class="btn-chart-control-wrap">
                        <div class="btn-chart-control pointer"><span>走勢圖</span></div>
                        <div class="btn-chart-control pointer"><span>k線圖</span></div>
                    </div>
                    <div id="btn-chart-range-wrap"></div>
                </div>
